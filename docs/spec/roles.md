...
- ERC-7943 enforcement (freeze a holder's balance, force a transfer out of a blocked wallet) is
  DEFAULT_ADMIN_ROLE's, not PAUSER_ROLE's: PAUSER stays a narrow emergency switch and never gains
  seizure power. No new bootstrap role is added to RWAFactory.
