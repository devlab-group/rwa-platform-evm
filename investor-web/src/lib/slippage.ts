...
/**
 * Upper cap on the slippage tolerance accepted for a purchase's ERC-20
 * approve() amount. This bound feeds directly into how much quote token the
 * investor authorizes the Vault to spend — an uncapped or fat-fingered value
 * (e.g. a stray extra digit) would silently approve spending far more than
 * intended. 5000 bps (50%) is already a very loose tolerance; nothing
